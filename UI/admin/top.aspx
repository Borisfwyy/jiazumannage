<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="top.aspx.cs" Inherits="UI.admin.top" %>
...
<body bgColor='#ffffff'>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" background="images/1470996804.jpg">
  <tr>
    <td width='20%' height="60"></td>
    <td width='20%' height="60">
        <asp:ImageButton ID="ImageButton1" runat="server"  ImageUrl="~/admin/picture/titlewangnew.jpg" Height="41px" Width="42px" BorderColor="#175773" title="首页" OnClick="ImageButton1_Click"/>
      </td>
    <td width='60%' align="right" valign="bottom" >
    	<table width="750" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td align="right" height="26" class="white" style="padding-right:10px;line-height:26px;">
        	<h4  align="center" ><span class="auto-style1">您好：<%=strUsername%>，欢迎使用家族人员管理系统！</span> <asp:LinkButton ID="LinkButton1" class="white" runat ="server" Text="注销退出" OnClick="btnLoginOut_Click" ForeColor="White"></asp:LinkButton>&nbsp;</h4>
      </td>
      </tr>
    </table></td>
  </tr>
